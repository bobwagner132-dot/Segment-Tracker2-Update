...
const APP_CACHE = "cst-app-v4";
const TILE_CACHE = "cst-tiles-v2";
...
self.addEventListener("fetch", (event) => {
  ...
  // We deliberately do NOT override request.mode — Leaflet fetches tiles
  // via <img> tags with mode "no-cors", which yields opaque responses that
  // browsers happily cache and re-serve. Forcing mode:"cors" here made
  // Catalina Safari/Chrome reject every tile because OSM/CartoDB tile
  // CDNs don't emit Access-Control-Allow-Origin on the tile path itself.
